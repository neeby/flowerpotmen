...
addHouse ( $_POST['Address'], $_POST['Suburb'], $_POST['PostCode'], $_POST['BedRooms'], $_POST['BathRooms'], $_POST['CarPorts'] , $_POST['Description'] , $_POST['Image'] , $_POST['WeeklyRent'] );
		...
		<form action='' method='POST'>
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="Image" value="<?php echo $_POST['Image'] ?>" required/><br /></td>
				</tr>				
				<tr>
