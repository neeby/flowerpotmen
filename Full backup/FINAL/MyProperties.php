...
//
    while ($row=mysqli_fetch_array($result,MYSQLI_NUM)) {
      //  echo "<td>".row[0]."</td>";
         echo "<tr><td><img src=".$row[8]." height='42' width='42'>".$row[0]."</td>"."<td>".$row[11]."</td>"."<td>".$row[1]."</td><td><a href='MyProperties.php?type=e&Address=".$row[1]."&Suburb=".$row[2]."&PostCode=".$row[3]."&Bed=".$row[4]."&Bath=".$row[5]."&Car=".$row[6]."&Description=".$row[7]."&Image=".$row[8]."&Rent=".$row[9]."&Code=".$row[0]."'><input type='button' value='Edit'></a></td><td><a href='MyProperties.php?type=d&property=".$row[0]."'><input type='button' value='Delete'></a></td><td><a href='properties.php'><input type='button' value='View Inspections'></a></td>";
        if($row[10]==0){
