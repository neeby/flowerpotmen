...
<html>
    <head>
        <?PHP
			...
			if(!isset($_SESSION['UAC_Level']) || $_SESSION['UAC_Level'] == "User" || $_SESSION['UAC_Level'] == "Visitor"  || $_SESSION['UAC_Level'] == "Owner"){
...
EOL;
		...
		switch ($_SESSION['UAC_Level']){
			case 'Staff':
				$NewUserOutput = $NewUserOutput . '<select name="newUser_uacLevel" id="uacLevel" selected="selected"><option value="1 (User)">1 (User)</option></select>';
				break;
			case 'Admin':
			case 'David':
